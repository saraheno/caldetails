...
TH1D* pip = ((TH2D*) ff->Get("pdg_ke"))->ProjectionY("",5211,5212);
TH1D *hpip = (TH1D*) pip->Clone();
TH1D* pim = ((TH2D*) ff->Get("pdg_ke"))->ProjectionY("",4789,4791);
TH1D *hpim = (TH1D*) pim->Clone();
TH1D* pi0 = ((TH2D*) ff->Get("pdg_ke"))->ProjectionY("",5111,5113);
TH1D *hpi0 = (TH1D*) pi0->Clone();
TH1D* ep = ((TH2D*) ff->Get("pdg_ke"))->ProjectionY("",4990,4990);
TH1D *hep = (TH1D*) ep->Clone();

TH1D* em = ((TH2D*) ff->Get("pdg_ke"))->ProjectionY("",5012,5012);
TH1D *hem = (TH1D*) em->Clone();
TH1D* p = ((TH2D*) ff->Get("pdg_ke"))->ProjectionY("",7212,7214);
TH1D *hp = (TH1D*) p->Clone();
TH1D* n = ((TH2D*) ff->Get("pdg_ke"))->ProjectionY("",7112,7114);
...
hpip->SetTitle("pi+;ke;fraction of ionizing energy");
hpim->SetTitle("pi-");
hpi0->SetTitle("pi0");
hep->SetTitle("e+");
hem->SetTitle("e-");
...
cout<<((TH2D*)ff->Get("pdg_ke"))->Integral(0,10000,0,101)<<endl;
